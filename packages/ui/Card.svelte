<script>
  ...
  const ENCODED_CONTROL_OR_SEPARATOR_PATTERN = /%(?:0[0-9a-f]|1[0-9a-f]|7f|2f|5c)/i;
  ...
  function resolveSafeHref(value) {
    ...
    return normalizedAllowedExternalHosts.has(normalizeHost(parsed.hostname)) ? parsed.toString() : '';
  }
