...
**Location:** `apps/hub/src/routes/avatar/+server.ts:60` — avatar proxy body handling
...
bounded 1 MB buffer rather than collecting chunks and copying them into a
second payload, so the remaining lack of early streaming is a deliberate
